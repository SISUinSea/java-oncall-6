...
public class MonthScheduleGenerator {
    public static List<String> generateMonthSchedule(Calendar calendar, TotalSchedule totalSchedule) {
        Deque<String> weekdaySchedule = totalSchedule.weekday().getEnoughScheduleAsDeque();
        Deque<String> holidaySchedule = totalSchedule.holiday().getEnoughScheduleAsDeque();
